...
//	  return ("home"); }
			...
			@RequestParam(value = "date") String date)
	{
		...
		List<Expense> expenses = expenseRepository.findByUserIdAndDate(userId,localDate);
		model.addObject("expenses", expenses);
...
//	public ModelAndView Past(@RequestParam(value = "date") String date)
//	{
//		// create entity 
//		// save entity 
//	
...
//	
//	List<Expense> expenses = expenseRepository.findByUserIdAndDate(userId,listOfDates);
//		model.addObject("expenses", expenses);
//		String dates = date;
//		LocalDate localDate = LocalDate.parse(dates);
//		if (userId == 0) {
...
//	public ModelAndView profile (@RequestParam(value = "username") String userName,
