			...
			<div class="form-class mt-5 mb-8">
				<div class="row">
					...
					<div class="col-lg-8 col-12 col-md-6">
						...
						<div class="row">
							<div class="col-lg-10 col-md-12 col-12 mt-4">
								<div class="graphbox">


									<div class="containers">
										<img
											src="https://economictimes.indiatimes.com/thumb/msid-80617412,width-1200,height-900,resizemode-4,imgsize-73603/budget.jpg?from=mdr"
