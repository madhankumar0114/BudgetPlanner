		...
		<div style="width:65%;margin:0 auto">
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="future_expense">Future Expense</a></li>
				...
				<div class="row">
				 <div class="col-12 col-lg-12">
					<div class="col-lg-4 col-12 col-md-6 mt-5" style="padding:0 !important">
						<div class="leftbox">
						    <h4 style="color:#fff" class="mb-4"><b>FUTURE EXPENSE</b></h4>
							<form action="future_expense"  method="post" id="cpa-form">
								<div class="row">
									...
									<c:forEach items="${expenses}" var="expense">
										<tr>
											...
											<td  align="right">
												...
												<a type="button" class="btn btn-danger" href="/delete_expense?id=${expense.expenseId}&page=future"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
