		...
		<div style="width:65%;margin:0 auto">
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class=""><a href="future_expense">Future Expense</a></li>
					<li class="active"><a href="past_expense">Past Expense</a></li>
				...
				<div class="row">
				 <div class="col-12 col-lg-12">
					<div class="col-lg-4 col-12 col-md-6 mt-5" style="padding:0 !important">
						<div class="leftbox">
						    <h4 style="color:#fff" class="mb-4"><b>PAST EXPENSE</b></h4>
								...
								<div class="row">
									...
									<div class="col-lg-12 col-12">
										...
										<div class="col-lg-12 col-12">
											...
											<input type="text" name="amount"	id="amount" class="form-control" value="${exp.amount}"  style="border: none !important;border-radius: 0 !important;">
										</div>
										<div class="col-lg-12 col-12 mb-2">
											<label style="font-weight:200;color:#fff">Date</label> 
											<input type="date" name="date" id="date" class="form-control" value="${exp.date}"  style="border: none !important;border-radius: 0 !important;">
										</div>
										<div class="form-action-buttons">
										    <input type="submit" class="btn btn-info" id="subbtn" style="background: #fff;color: #444;" value="Submit">
										</div>
								...
								<tbody>
									<c:forEach items="${expenses}" var="expense">
										<tr>
											...
											<td>${expense.date}</td>
											<td  align="right">
												<a type="button" class="btn btn-success" href="/past_expense?id=${expense.expenseId}"><i class="fa fa-edit"></i></a> 
												<a type="button" class="btn btn-danger" href="/delete_expense?id=${expense.expenseId}&page=past"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
